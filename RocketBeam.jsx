...
function pulse(t) {
  return (
    0.5 +
    0.5 * Math.sin(t * 3.0) +
    0.25 * Math.sin(t * 7.2 + 1.0) +
    0.15 * Math.sin(t * 11.5 + 2.3)
  );
}
...
export default function RocketBeam() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full max-w-xl h-[400px] bg-[#010108] overflow-hidden rounded-xl flex flex-col items-center"
    >
